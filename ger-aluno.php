      ...
      <fieldset class="border p-3 mb-3">
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <input type="text" name="nome" id="nome" class="form-control" value="<?= $aluno->nome ?? null; ?>" required>
          </div>
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <input type="text" name="celular" id="celular" class="form-control" value="<?= $aluno->celular ?? null; ?>"
              data-mascara="(00)00000-0000">
          </div>
          <div class="col-md-3">
